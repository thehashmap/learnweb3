...
contract Exchange is ERC20 {
        ...
        returns (uint256)
    {
        ...
        uint256 minTokenAmountRequired =
            (msg.value * tokenReserveBalance) / ethReservePriorToFunctionCall;
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 ethToReturn =
            (ethReserveBalance * amountOfLPTokens) / lpTokenTotalSupply;
        uint256 tokenToReturn =
            (getReserve() * amountOfLPTokens) / lpTokenTotalSupply;
